<div class="container">
        ...
        <div class="col-md-8">
            <?php if ($resultados != FALSE) {
                foreach ($resultados->result() as $alumno) {
                    ...
                    <div class="form-group">
                        <label>Nombre</label>
                        <input type="text" name="nombre" class="form-control" readonly="" value="<?php echo $alumno->nombre; ?>">
                    </div>
                    <div class="form-group">
    ...
    <?php }
            ...
            <div class="form-group">
                <a href="<?php echo base_url(); ?>welcome/editar_informacion"><button type="button" class="btn btn-primary">Editar Información</button></a>
                <a href="<?php echo base_url(); ?>welcome/editar_foto"><button type="button" class="btn btn-info">Editar Foto</button></a>
            </div>
        </div>
    </div>
</div>